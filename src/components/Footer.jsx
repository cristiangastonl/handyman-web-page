    ...
    <footer style={{ borderTop: "none", padding: "40px 24px 28px", background: "#4A4A4A" }}>
      <div style={{ maxWidth: 940, margin: "0 auto" }}>
        ...
        <div style={{ borderTop: "1px solid rgba(255,255,255,0.15)", paddingTop: 20, textAlign: "center" }}>
          ...
          <div style={{ fontSize: 10, color: "rgba(255,255,255,0.25)", marginTop: 6 }}>{t("footer.credit")} <a href="https://weekly-code-stream.vercel.app/es" target="_blank" rel="noopener noreferrer" style={{ fontWeight: 600, color: "rgba(255,255,255,0.4)", textDecoration: "none" }}>CGL</a></div>
        </div>
      </div>
    </footer>
  );
